...
const AddProduct = () => {
  ...
  const generateBarcode = async () => {
    ...
    try {
      const response = await axios.post("https://ecommerce-backend-zssq.onrender.com/api/products/generate-barcode", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://ecommerce-backend-zssq.onrender.com/api/products", {
