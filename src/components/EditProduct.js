...
const EditProduct = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const response = await axios.get(`https://ecommerce-backend-lv9n.onrender.com/api/products/unique/${uniqueCodeInput}`);
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.put(
      `https://ecommerce-backend-lv9n.onrender.com/api/products/${product.id}`,
      {
