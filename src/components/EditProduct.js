...
const EditProduct = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      const response = await axios.get(`https://ecommerce-backend-theta-plum.vercel.app/api/products/unique/${uniqueCodeInput}`);
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.put(
      `https://ecommerce-backend-theta-plum.vercel.app/api/products/${product.id}`,
      {
